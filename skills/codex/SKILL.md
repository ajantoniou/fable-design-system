...
4. Run it in a real browser, scroll it, keep the console clean, check ≥1 breakpoint.
5. Self-critique by measuring (contrast ratios, value separation) and fix root causes, not symptoms.
